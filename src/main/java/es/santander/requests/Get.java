...
public class Get {
	...
	/**
	 * This method takes care of making a GET request.
	 * 
	 * @param endpoint
	 * @param headerGet
	 * @param statusCode
	 ...
	 * @throws Exception
	 */
	public ReqResponse executeGet(String endpoint, String[] header, String statusCode, String requestContenType)
			throws Exception {

		try {
			// Step - Title.
			MessageLibrary.log("Se va a realizar un GET con la URL: <font color='Teal'>" + endpoint + "</font>");
			...
			// GET.
			response02 = ws.createRestRequest().contentType(contentType).setHeaders(mapHeader).get(endpoint);
			...
			// Result - Title.
			MessageLibrary
					.log("Se ha realizado y validado el GET con la URL: <font color='Teal'>" + endpoint + "</font>");

		} catch (Exception e) {
			// New exception.
			throw new Exception("al realizar el GET: <font color='red'>" + e + "</font>.");
		}
		return response02;
	}
}