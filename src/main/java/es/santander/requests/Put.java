...
public class Put {
	...
	/**
	 * This method takes care of making a PUT request.
	 * 
	 * @param endpoint
	 * @param header
	 * @param statusCode
	 ...
	 * @throws Exception
	 */
	public ReqResponse executePut(String endpoint, String[] header, String statusCode, String requestContenType,
			String bodyRequest) throws Exception {
		try {
			// Step - Title.
			MessageLibrary.log("Se va a realizar un PUT con la URL: <font color='Teal'>" + endpoint + "</font>");
			...
			// Result - Title.
			MessageLibrary
					.log("Se ha realizado y validado el PUT con la URL: <font color='Teal'>" + endpoint + "</font>");

		} catch (Exception e) {
			// New exception.
			throw new Exception("al realizar el PUT: <font color='red'>" + e + "</font>.");
		}
		return response;
	}
}